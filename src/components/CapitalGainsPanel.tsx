        ...
        {hasAny && (
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            {result.taxableStcgOther > 0 && (
              <div className="bg-[#004030]/4 border border-[#004030]/10 rounded-xl px-4 py-3">
                <p className="text-xs font-semibold text-[#004030]/60 uppercase tracking-wider mb-1">
    ...
    <div className={`rounded-xl border p-4 transition-all ${
      ...
      <div className="flex items-center justify-between mb-1.5">
        ...
        <span className={`text-xs font-bold px-2 py-0.5 rounded-full ${
          isFlat
            ? 'bg-[#004030]/8 text-[#004030]'
            : 'bg-[#004030]/6 text-[#004030]'
        }`}>{rateLabel}</span>
      </div>
...
function Chip({ label, value, color }: { label: string; value: string; color: 'green' | 'purple' | 'orange' | 'gray' }) {
  const colors = {
    green:  'bg-[#004030]/8 text-[#004030] border-[#004030]/15',
    purple: 'bg-[#004030]/6 text-[#004030] border-[#004030]/15',
    orange: 'bg-[#004030]/6 text-[#004030] border-[#004030]/15',
    gray:   'bg-[#004030]/4 text-[#004030]/50 border-[#004030]/10',
  };
  return (
